    ...
    <div className="sidebar">
      ...
      <div className="sidebar__option">
         ...
         <select name="color" id="color" onChange = {(e) => handleColor(e.target.value)} disabled = {myState.play? true: false}>
            <option value="#0095C7" style={{color:'#0095C7'}}>Blue</option> 
            <option value='#16FF00' style={{color:'#16FF00'}}>Green</option>
            <option value="#DA0037" style={{color:'#DA0037'}}>Red</option>
            <option value="grey" style={{color:'grey'}}>Black</option>
            <option value="#FFED00" style={{color:'#FFED00'}}>Yellow</option>
         </select>
      </div>
